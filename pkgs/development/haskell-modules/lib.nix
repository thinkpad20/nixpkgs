...
rec {
  ...
  addLibrarySystemDepend = drv: x: addLibrarySystemDepends drv [x];
  addLibrarySystemDepends = drv: xs: overrideCabal drv (drv: { librarySystemDepends = (drv.librarySystemDepends or []) ++ xs; });
